...
//
var EqualsIn Checker = &equalsInChecker{
	&CheckerInfo{Name: "EqualsIn", Params: []string{"obtained", "expected"}},
}

func (checker *equalsInChecker) Check(params []interface{}, names []string) (result bool, error string) {
	defer func() {
		if v := recover(); v != nil {
			result = false
			error = fmt.Sprint(v)
